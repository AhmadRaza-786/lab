...
public class IabHelper {
    ...
    public boolean handleActivityResult(int r13, int r14, android.content.Intent r15) {
        ...
        L_0x00e2:
            r2 = 0
            com.android.vending.billing.util.Purchase r3 = new com.android.vending.billing.util.Purchase     // Catch:{ JSONException -> 0x0151 }
            java.lang.String r8 = r12.mPurchasingItemType     // Catch:{ JSONException -> 0x0151 }
            r3.<init>(r8, r4, r0)     // Catch:{ JSONException -> 0x0151 }
            java.lang.String r7 = r3.getSku()     // Catch:{ JSONException -> 0x020c }
            boolean r8 = r12.isTestSku(r7)     // Catch:{ JSONException -> 0x020c }
            if (r8 != 0) goto L_0x0138
            java.lang.String r8 = r12.mSignatureBase64     // Catch:{ JSONException -> 0x020c }
            boolean r8 = com.android.vending.billing.util.Security.verifyPurchase(r8, r4, r0)     // Catch:{ JSONException -> 0x020c }
            if (r8 != 0) goto L_0x0138
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x020c }
            r8.<init>()     // Catch:{ JSONException -> 0x020c }
            java.lang.String r9 = "Purchase signature verification FAILED for sku "
            java.lang.StringBuilder r8 = r8.append(r9)     // Catch:{ JSONException -> 0x020c }
            java.lang.StringBuilder r8 = r8.append(r7)     // Catch:{ JSONException -> 0x020c }
            java.lang.String r8 = r8.toString()     // Catch:{ JSONException -> 0x020c }
            r12.logError(r8)     // Catch:{ JSONException -> 0x020c }
            com.android.vending.billing.util.IabResult r6 = new com.android.vending.billing.util.IabResult     // Catch:{ JSONException -> 0x020c }
            r8 = -1003(0xfffffffffffffc15, float:NaN)
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x020c }
            r9.<init>()     // Catch:{ JSONException -> 0x020c }
            java.lang.String r10 = "Signature verification failed for sku "
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ JSONException -> 0x020c }
            java.lang.StringBuilder r9 = r9.append(r7)     // Catch:{ JSONException -> 0x020c }
            java.lang.String r9 = r9.toString()     // Catch:{ JSONException -> 0x020c }
            r6.<init>(r8, r9)     // Catch:{ JSONException -> 0x020c }
            com.android.vending.billing.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener     // Catch:{ JSONException -> 0x020c }
            if (r8 == 0) goto L_0x0135
            com.android.vending.billing.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener     // Catch:{ JSONException -> 0x020c }
            r8.onIabPurchaseFinished(r6, r3)     // Catch:{ JSONException -> 0x020c }
        L_0x0135:
            r8 = 1
            goto L_0x0005
        L_0x0138:
            java.lang.String r8 = "Purchase signature successfully verified."
            r12.logDebug(r8)     // Catch:{ JSONException -> 0x020c }
            com.android.vending.billing.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
    ...
    public static String getResponseDesc(int code2) {
        ...
        if (code2 <= -1000) {
            int index = -1000 - code2;
            if (index < 0 || index >= iabhelper_msgs.length) {
                return String.valueOf(code2) + ":Unknown IAB Helper Error";
            }
            return iabhelper_msgs[index];
        } else if (code2 < 0 || code2 >= iab_msgs.length) {
            return String.valueOf(code2) + ":Unknown";
        } else {
            return iab_msgs[code2];
        }
    }
    ...
    private boolean isTestSku(String sku) {
        ...
        try {
            if ("android.test".equals(sku.substring(0, 12))) {
                return true;
            }
            return false;
        } catch (Exception e) {
