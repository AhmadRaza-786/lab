...
public class GestureListener implements GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener, ScaleGestureDetector.OnScaleGestureListener {
    ...
    public boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
        ...
        if (motionEvent2.getPointerCount() == 2) {
            ...
            if (access$100 >= 0 && access$100 < 2 && access$1002 >= 0 && access$1002 < 2) {
                if (!this.mInPanTransformGesture) {
                    ...
                    if (this.mInRotateTransformGesture || Math.abs(rotation) > _FP_GESTURE_ROTATION_THRESHOLD_DEGREES) {
                        ...
                        this.mCompanionView.onGestureListener(i, 2, true, x, y, 1.0f, 1.0f, f7, 0.0f, 0.0f);
                        f4 = 0.0f;
                    }
                }
                if (!this.mInZoomTransformGesture && !this.mInRotateTransformGesture) {
                    if (isPanGesture(this.mDownTouchPoints[access$100], this.mDownTouchPoints[access$1002], touchPointArr[0], touchPointArr[1])) {
                        ...
                        this.mCompanionView.onGestureListener(i, 1, true, x, y, 1.0f, 1.0f, f4, -1.0f * f, -1.0f * f2);
            ...
            if (z) {
                this.mCompanionView.onGestureListener(8, 4, true, motionEvent.getX(0), motionEvent2.getY(0), 1.0f, 1.0f, 0.0f, f5, f6);
    ...
    public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        ...
        this.mCompanionView.onGestureListener(i, 0, true, focusX, focusY, f, f3, 0.0f, 0.0f, 0.0f);
        return true;
    }
